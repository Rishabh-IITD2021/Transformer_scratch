...
class BilingualDataset(Dataset):
    def __init__(self,data,tokenizer_src, tokenizer_tgt, src_lang,tgt_lang, seq_len) -> None:
        super().__init__()
        self.data = data
    ...
    def __getitem__(self,index: Any)-> Any:
            ...
            enc_pad_tokens =  (self.seq_len - len(enc_input_tokens))-2
            dec_pad_tokens =  (self.seq_len - len(dec_input_tokens))-1
            
            if enc_pad_tokens <0 or dec_pad_tokens <0:
                raise ValueError("seq_len is too large")
